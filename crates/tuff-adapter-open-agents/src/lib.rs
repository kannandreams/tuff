...
pub const HOOK_COMPATIBILITY: CompatibilityMatrix = CompatibilityMatrix {
    ...
    events: &[
        ...
        CompatibilityEntry {
            ...
            caveat: Some(
                "No harness documents a hook mechanism for the shared .agents layout; the registration is kept for tools that adopt it.",
            ),
            source: None,
            since_harness_version: None,
            until_harness_version: None,
...
impl AgentAdapter for OpenAgents {
