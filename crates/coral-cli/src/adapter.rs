...
use coral_adapter_claude::Claude;
use coral_adapter_codex::Codex;
use coral_adapter_cursor::Cursor;
use coral_adapter_open_agents::OpenAgents;
...
impl AgentAdapter for AdapterKind {
    ...
    fn remove_hook_settings(
        &self,
        repo_root: &Path,
        managed_hooks: &[coral_core::lockfile::ManagedHook],
    ) -> Result<()> {
        self.implementation()
