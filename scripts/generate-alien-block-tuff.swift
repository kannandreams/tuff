...
guard args.count == 3 else {
    fputs("usage: generate-alien-block-tuff.swift <font.ttf> <output.txt>\n", stderr)
    exit(2)
}
...
let flipTextContext = env["TUFF_ALIEN_FLIP_CONTEXT"] != "0"
let topDownOutput = env["TUFF_ALIEN_TOP_DOWN"] != "0"
...
let mirrorGlyphs = env["TUFF_ALIEN_MIRROR_GLYPHS"] == "1"
